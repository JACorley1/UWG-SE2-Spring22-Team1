...
class TestConstructor(unittest.TestCase):    
    ...
    def test_none_authentication_manager(self):
        """
        Check if an exception is raised if authentication_manager is None.
        """

        self.assertRaises(Exception, _RequestHandler, (ServiceManager(), None), "Check if an exception is raised.")

    def test_authentication_manager_incorrect_type(self):
        
        """
        Check if an exception is raised if authentication_manager is not a ServiceManager.
        """

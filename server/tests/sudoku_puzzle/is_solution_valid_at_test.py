...
class TestIsSolutionValidAt(unittest.TestCase):    
    """
    Tests for the SudokuPuzzle's is_solution_valid_at method.
    ...
    def test_valid_solution(self):
        """
        Tests if a solution is valid for a specified cell when the entire solution is empty.
        """
        puzzle = SudokuPuzzle()

        self.assertTrue(puzzle.is_solution_valid_at(0, 0, 1), "Check if a valid solution is valid")
    ...
    def test_number_already_on_row(self):
        ...
        self.assertFalse(puzzle.is_solution_valid_at(1, 0, 1), "Check if a valid solution is invalid")
    ...
    def test_number_already_on_col(self):
        ...
        self.assertFalse(puzzle.is_solution_valid_at(0, 1, 1), "Check if a valid solution is invalid")
    ...
    def test_number_already_in_square(self):
        ...
        self.assertFalse(puzzle.is_solution_valid_at(1, 1, 1), "Check if a valid solution is invalid")
    ...
    def test_col_too_low(self):
        ...
        with self.assertRaises(IndexError):
            puzzle.is_solution_valid_at(-1, 0, 1)
    ...
    def test_col_too_high(self):
        ...
        puzzle = SudokuPuzzle()
        with self.assertRaises(IndexError):
            puzzle.is_solution_valid_at(PUZZLE_SIZE, 0, 1)
    ...
    def test_invalid_col_type(self):
        ...
        with self.assertRaises(TypeError):
            puzzle.is_solution_valid_at("0", 0, 1)
    ...
    def test_row_too_low(self):
        ...
        puzzle = SudokuPuzzle()
        with self.assertRaises(IndexError):
            puzzle.is_solution_valid_at(0, -1, 1)
    ...
    def test_row_too_high(self):
        ...
        puzzle = SudokuPuzzle()
        with self.assertRaises(IndexError):
            puzzle.is_solution_valid_at(0, PUZZLE_SIZE, 1)
    ...
    def test_number_too_high(self):
        ...
        puzzle = SudokuPuzzle()
        with self.assertRaises(Exception):
            puzzle.is_solution_valid_at(0, 0, PUZZLE_SIZE + 1)
